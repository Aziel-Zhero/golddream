...
export function Footer() {
  ...
  // O acesso administrativo só aparece se existir o documento do usuário na coleção roles_administrador
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              O melhor da moda premium. Gold Dream Multimarcas - Elegância e qualidade para o seu dia a dia.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-primary transition-colors">Trocas</Link></li>
              <li><Link href="#" className="hover:text-primary transition-colors">Tamanhos</Link></li>
          ...
          <div className="bg-muted/30 p-6 rounded-2xl border">
            ...
            <p className="text-xs text-muted-foreground mb-6 leading-relaxed">
              Receba ofertas da Gold Dream Multimarcas e cupons de Black Friday exclusivos!
            </p>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center text-[10px] text-muted-foreground gap-4 uppercase tracking-widest">
          <div className="flex items-center gap-4">
            ...
            {adminRole && (
              <Link href="/admin" className="flex items-center gap-1 text-primary font-black hover:underline bg-primary/10 px-2 py-1 rounded">
